    ...
    <div class="flex flex-col lg:flex-row gap-8">
        ...
        <div class="flex-1 min-w-0 space-y-6">
            ...
            <div class="bg-gradient-to-r from-emerald-600 to-teal-500 text-white rounded-xl p-8 shadow-md">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h2 class="mt-2 text-4xl font-bold">{{ $counts['commodities'] }}</h2>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <p class="mt-2 text-3xl font-semibold text-gray-800">{{ $counts['commodity_categories'] }}</p>
                </div>
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    <p class="text-sm text-gray-500 uppercase tracking-wide">Varieties</p>
                    <p class="mt-2 text-3xl font-semibold text-gray-800">{{ $counts['commodity_varieties'] }}</p>
                </div>
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    <p class="text-sm text-gray-500 uppercase tracking-wide">Crops</p>
                    <p class="mt-2 text-3xl font-semibold text-gray-800">{{ $counts['crops'] }}</p>
                </div>
            </div>
        ...
        <aside class="w-full lg:w-1/3 space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <p class="mt-2 text-3xl font-semibold text-gray-800">{{ $counts['livestock'] }}</p>
            </div>

            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                <p class="text-sm text-gray-500 uppercase tracking-wide">Resources</p>
                <p class="mt-2 text-3xl font-semibold text-gray-800">{{ $counts['resources'] }}</p>
            </div>

            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                <p class="text-sm text-gray-500 uppercase tracking-wide">Users</p>
                <p class="mt-2 text-3xl font-semibold text-gray-800">{{ $counts['users'] }}</p>
            </div>
