<div class="p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <tbody>
                    @foreach($crops as $crop)
                        <tr class="border-t">
                            ...
                            <td class="px-4 py-2">{{ $crop['slug'] }}</td>
                            <td class="px-4 py-2">
                                <button wire:click="editCrop({{ $crop['id'] }})" class="mr-2 px-2 py-1 bg-blue-500 text-white rounded">Edit</button>
                                <button wire:click="deleteCrop({{ $crop['id'] }})" class="px-2 py-1 bg-red-500 text-white rounded">Delete</button>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
        ...
        <div class="bg-white shadow rounded p-4">
            <h3 class="font-semibold mb-2">@if($editingId) Edit @else New @endif Crop</h3>
            <div class="mb-2">
