<?php if(! isset($__env->__pushonce_filament_scripts_select_component)): $__env->__pushonce_filament_scripts_select_component = 1; $__env->startPush('filament-scripts'); ?>
    <script>
...
<?php $component->withAttributes(['column-span' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($formComponent->getColumnSpan()),'error-key' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($formComponent->getName()),'for' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($formComponent->getId()),'help-message' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($formComponent->getHelpMessage()),'hint' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($formComponent->getHint()),'label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($formComponent->getLabel()),'required' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($formComponent->isRequired())]); ?>
    <div
        x-data="select({
            ...
            initialDisplayValue: <?php echo e(data_get($this, $formComponent->getName()) !== null ? json_encode($formComponent->getDisplayValue(data_get($this, $formComponent->getName()))): 'null'); ?>,
    ...
    >
        ...
        <div
            ...
            tabindex="1"
            <?php endif; ?>
            class="bg-white relative w-full border rounded shadow-sm pl-3 pr-10 py-2 text-left cursor-default focus-within:border-blue-300 focus-within:ring focus-within:ring-blue-200 focus-within:ring-opacity-50 <?php echo e($formComponent->isDisabled() ? 'text-gray-500' : ''); ?> <?php echo e($errors->has($formComponent->getName()) ? 'border-danger-600 motion-safe:animate-shake' : 'border-gray-300'); ?>"
        >
            <input
                x-show="! open"
                x-bind:value="displayValue ?? '<?php echo e(__($formComponent->getPlaceholder())); ?>'"
                type="text"
                readonly
...
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['x-show' => '! loading','x-cloak' => true,'class' => 'w-5 h-5 text-gray-400']); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\Praise Web Solutions\NAROinfoHub\vendor\filament\filament\packages\forms\src/../resources/views/components/select.blade.php ENDPATH**/ ?>