...
} elseif ($_instance->childHasBeenRendered('riwVAA7')) {
    $componentId = $_instance->getRenderedChildComponentId('riwVAA7');
    $componentTag = $_instance->getRenderedChildComponentTagName('riwVAA7');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('riwVAA7');
} else {
    $response = \Livewire\Livewire::mount(\Livewire\Livewire::getAlias($widget));
    $html = $response->html();
    $_instance->logRenderedChild('riwVAA7', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /var/www/projects/NAROinfoHub/vendor/filament/filament/resources/views/dashboard.blade.php ENDPATH**/ ?>