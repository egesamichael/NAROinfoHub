<?php if(! isset($__env->__pushonce_filament_styles_markdown_editor_component)): $__env->__pushonce_filament_styles_markdown_editor_component = 1; $__env->startPush('filament-styles'); ?>
...
<?php if(! isset($__env->__pushonce_filament_scripts_markdown_editor_component)): $__env->__pushonce_filament_scripts_markdown_editor_component = 1; $__env->startPush('filament-scripts'); ?>
...
<?php $component->withAttributes(['column-span' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($formComponent->getColumnSpan()),'error-key' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($formComponent->getName()),'for' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($formComponent->getId()),'help-message' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($formComponent->getHelpMessage()),'hint' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($formComponent->getHint()),'label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($formComponent->getLabel()),'required' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($formComponent->isRequired())]); ?>
    <div
        x-data="markdownEditor({
            attachmentDirectory: <?php echo e(json_encode($formComponent->getAttachmentDirectory())); ?>,
            attachmentDisk: <?php echo e(json_encode($formComponent->getAttachmentDiskName())); ?>,
            attachmentUploadUrl: <?php echo e(json_encode($formComponent->getAttachmentUploadUrl())); ?>,
            tab: '<?php echo e($formComponent->isDisabled() ? 'preview' : 'write'); ?>',
        })"
        x-init="init"
        wire:ignore
    >
        <div class="space-y-2">
            <?php if (! ($formComponent->isDisabled())): ?>
                <div class="flex items-stretch h-8" x-bind:class="{ 'justify-end': tab === 'preview', 'justify-between': tab !== 'preview' }">
                    <markdown-toolbar
                        for="<?php echo e($formComponent->getId()); ?>"
                        class="flex items-stretch space-x-4 rtl:space-x-reverse"
                        x-show="tab !== 'preview'"
                    >
                        <?php if($formComponent->hasToolbarButton(['bold', 'italic', 'strike'])): ?>
                            <div class="flex items-stretch space-x-1 rtl:space-x-reverse">
                                <?php if($formComponent->hasToolbarButton('bold')): ?>
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'filament::components.button','data' => ['size' => 'small','class' => 'text-base','title' => ''.e(__('forms::fields.markdownEditor.toolbarButtons.bold')).'']]); ?>
<?php $component->withName('filament::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['size' => 'small','class' => 'text-base','title' => ''.e(__('forms::fields.markdownEditor.toolbarButtons.bold')).'']); ?>
                                        <md-bold>
...
<?php endif; ?>
                                ...
                                <?php if($formComponent->hasToolbarButton('italic')): ?>
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'filament::components.button','data' => ['size' => 'small','class' => 'text-base','title' => ''.e(__('forms::fields.markdownEditor.toolbarButtons.italic')).'']]); ?>
<?php $component->withName('filament::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['size' => 'small','class' => 'text-base','title' => ''.e(__('forms::fields.markdownEditor.toolbarButtons.italic')).'']); ?>
                                        <md-italic>
...
<?php endif; ?>
                                ...
                                <?php if($formComponent->hasToolbarButton('strike')): ?>
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'filament::components.button','data' => ['size' => 'small','class' => 'text-base','title' => ''.e(__('forms::fields.markdownEditor.toolbarButtons.strike')).'']]); ?>
<?php $component->withName('filament::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['size' => 'small','class' => 'text-base','title' => ''.e(__('forms::fields.markdownEditor.toolbarButtons.strike')).'']); ?>
                                        <md-strikethrough>
...
<?php endif; ?>
                        ...
                        <?php if($formComponent->hasToolbarButton(['link', 'attachFiles', 'code'])): ?>
                            <div class="flex items-stretch space-x-1 rtl:space-x-reverse">
                                <?php if($formComponent->hasToolbarButton('link')): ?>
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'filament::components.button','data' => ['size' => 'small','class' => 'text-base','title' => ''.e(__('forms::fields.markdownEditor.toolbarButtons.link')).'']]); ?>
<?php $component->withName('filament::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['size' => 'small','class' => 'text-base','title' => ''.e(__('forms::fields.markdownEditor.toolbarButtons.link')).'']); ?>
...
<?php endif; ?>
                                ...
                                <?php if($formComponent->hasToolbarButton('attachFiles')): ?>
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'filament::components.button','data' => ['size' => 'small','class' => 'text-base','title' => ''.e(__('forms::fields.markdownEditor.toolbarButtons.attachFiles')).'']]); ?>
<?php $component->withName('filament::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['size' => 'small','class' => 'text-base','title' => ''.e(__('forms::fields.markdownEditor.toolbarButtons.attachFiles')).'']); ?>
...
<?php endif; ?>
                                ...
                                <?php if($formComponent->hasToolbarButton('code')): ?>
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'filament::components.button','data' => ['size' => 'small','class' => 'text-base','title' => ''.e(__('forms::fields.markdownEditor.toolbarButtons.code')).'']]); ?>
<?php $component->withName('filament::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['size' => 'small','class' => 'text-base','title' => ''.e(__('forms::fields.markdownEditor.toolbarButtons.code')).'']); ?>
...
<?php endif; ?>
                        ...
                        <?php if($formComponent->hasToolbarButton(['bullet', 'number'])): ?>
                            <div class="flex items-stretch space-x-1 rtl:space-x-reverse">
                                <?php if($formComponent->hasToolbarButton('bullet')): ?>
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'filament::components.button','data' => ['size' => 'small','class' => 'text-base','title' => ''.e(__('forms::fields.markdownEditor.toolbarButtons.bullet')).'']]); ?>
<?php $component->withName('filament::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['size' => 'small','class' => 'text-base','title' => ''.e(__('forms::fields.markdownEditor.toolbarButtons.bullet')).'']); ?>
...
<?php endif; ?>
                                ...
                                <?php if($formComponent->hasToolbarButton('number')): ?>
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'filament::components.button','data' => ['size' => 'small','class' => 'text-base','title' => ''.e(__('forms::fields.markdownEditor.toolbarButtons.number')).'']]); ?>
<?php $component->withName('filament::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['size' => 'small','class' => 'text-base','title' => ''.e(__('forms::fields.markdownEditor.toolbarButtons.number')).'']); ?>
...
<?php endif; ?>
                    ...
                    <?php if($formComponent->hasToolbarButton(['write', 'preview']) && ! $formComponent->isDisabled()): ?>
                        <div class="flex items-center space-x-4 rtl:space-x-reverse">
                            <?php if($formComponent->hasToolbarButton('write')): ?>
                                <button
                                    class="font-mono text-sm hover:underline"
                                    x-on:click.prevent="tab = 'write'"
                                    x-bind:class="{ 'text-gray-400': tab !== 'write' }"
                                >
                                    <?php echo e(__('forms::fields.markdownEditor.toolbarButtons.write')); ?>

                                </button>
                            <?php endif; ?>

                            <?php if($formComponent->hasToolbarButton('preview')): ?>
                                <button
                                    class="font-mono text-sm hover:underline"
                                    x-on:click.prevent="tab = 'preview'"
                                    x-bind:class="{ 'text-gray-400': tab !== 'preview' }"
                                >
                                    <?php echo e(__('forms::fields.markdownEditor.toolbarButtons.preview')); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH /var/www/projects/NAROinfoHub/vendor/filament/filament/packages/forms/resources/views/components/markdown-editor.blade.php ENDPATH**/ ?>